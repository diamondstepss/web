  ...
  return [
  {
    ...
    items: [
      ...
      },
      {
        ...
        a: `Yes — prepaid orders over ₹${SITE.prepaidDiscountMinOrder} get an extra ${SITE.prepaidDiscountType === 'FLAT' ? `₹${SITE.prepaidDiscountPct}` : `${SITE.prepaidDiscountPct}%`} off, and you always skip the ₹${SITE.codFee} COD handling fee. It is the cheapest way to order.`,
      },
      {
